            ...
            <div class="">
                <div class="card p-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="editName" name="name" value="{{$staff->name}}">
                    </div>
                    @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="editPhone" name="phone" value="{{$staff->phone}}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="editAddress" name="address" value="{{$staff->address}}">
                    </div>
                    ...
                    <div class="row">
                        ...
                        @enderror
                        <div class="col-md-6">
                            <img src="{{asset('public/storage/'. $staff->image)}}" alt="Client Logo" class="img-fluid" style="max-width: 100px;">
                        </div>
                    </div>
                </div>
            </div>
